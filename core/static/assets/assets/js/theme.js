...
/**
 * If there are prototype properties, define them on the constructor's prototype. If there are static
 *param Constructor - The constructor function that will be used to instantiate the class.
 * @param protoProps - An object literal containing properties to be added to the prototype of the
 * class.
 * @param staticProps - An object literal containing properties to be defined on the constructor.
 * @returns A constructor function. properties, define them on the constructor. Return the constructor.
 * @
 */
...
/* Checking if the array is an array and if it has a length. */
